...
function HeroSection() {
    ...
    return (
        <section
            className="relative pb-4 pt-[6.5rem] lg:pb-8 lg:pt-28"
            id="hero"
            ref={ref}
        >
            <Image
            ...
            <div className="container relative">
                <div className="grid gap-y-8 xs:grid-cols-[350px] xs:justify-center md:grid-cols-[repeat(2,350px)] md:items-center lg:grid-cols-[420px,520px] lg:gap-x-12 xl:grid-cols-[470px,550px]">
                    ...
                    <motion.div
                        initial={{ scale: 0, opacity: 0 }}
                        animate={{ scale: 1, opacity: 1 }}
                        className="max-w-[400px] rotate-[15deg] justify-self-center lg:max-w-[initial]"
                    >
                        <Image
                            src={HomeBread}
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center gap-y-8 xs:flex-row xs:justify-between xs:gap-y-0 md:col-start-1 md:col-end-3"
                    >
                        <Link
